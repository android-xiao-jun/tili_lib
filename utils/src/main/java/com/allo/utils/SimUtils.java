...
public class SimUtils {
    ...
    public static final int SLOT_INDEX_1 = 0;
    public static final int SLOT_INDEX_2 = 1;
    ...
    @RequiresPermission(READ_PHONE_STATE)
    public static int activeSimCount(){
    ...
    public static SubscriptionManager getSubscriptionManager() {
        return SubscriptionManager.from(Utils.getApp());
    }
}
