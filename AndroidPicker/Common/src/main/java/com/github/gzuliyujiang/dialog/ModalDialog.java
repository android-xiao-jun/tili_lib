...
public abstract class ModalDialog extends BottomDialog implements View.OnClickListener {
    ...
    protected View createHeaderView() {
        switch (DialogConfig.getDialogStyle()) {
            ...
            case DialogStyle.App:
                return View.inflate(activity, R.layout.dialog_header_style_app, null);
            default:
    ...
    protected View createTopLineView() {
        if (DialogConfig.getDialogStyle() == DialogStyle.Default || DialogConfig.getDialogStyle() == DialogStyle.App) {
    ...
    protected void initView() {
        ...
        if (DialogConfig.getDialogStyle() != DialogStyle.App){
