...
import com.nky.database.db.sqlite.CursorUtils;
import com.nky.database.db.sqlite.DbModelSelector;
import com.nky.database.db.sqlite.Selector;
import com.nky.database.db.sqlite.SqlInfo;
import com.nky.database.db.sqlite.SqlInfoBuilder;
import com.nky.database.db.sqlite.WhereBuilder;
import com.nky.database.db.table.DbModel;
import com.nky.database.db.table.Id;
import com.nky.database.db.table.Table;
import com.nky.database.db.table.TableUtils;
import com.nky.database.exception.DbException;
import com.nky.database.util.IOUtils;

/**
 * 参考文档：https://blog.csdn.net/jjwwmlp456/article/details/44084411
 * */
...
public class DbUtils {
     ...
     * key: dbName
     */
    private static final HashMap<String, DbUtils> daoMap = new HashMap<String, DbUtils>();
    ...
    //查看是否存在目标数据库 不存在则创建一个 如果存在 则使用此数据库
    ...
    public static class DaoConfig {
        ...
        private String dbName = "WXLB_HW.db"; // default db name
