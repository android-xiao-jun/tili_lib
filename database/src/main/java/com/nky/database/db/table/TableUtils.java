...
package com.nky.database.db.table;

import android.text.TextUtils;
import com.nky.database.db.annotation.Id;
import com.nky.database.db.annotation.Table;
import com.nky.database.db.converter.ColumnConverterFactory;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static final ConcurrentHashMap<String, HashMap<String, Column>> entityColumnsMap = new ConcurrentHashMap<String, HashMap<String, Column>>();
     ...
     * key: entityType.name
     */
    private static final ConcurrentHashMap<String, com.nky.database.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.nky.database.db.table.Id>();

    /* package */
    static synchronized com.nky.database.db.table.Id getId(Class<?> entityType) {
        ...
        com.nky.database.db.table.Id id = new com.nky.database.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.nky.database.db.table.Id id = getId(entityType);
