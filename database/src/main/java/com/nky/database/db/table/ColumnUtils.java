...
import com.nky.database.db.annotation.*;
import com.nky.database.db.annotation.Column;
import com.nky.database.db.annotation.Finder;
import com.nky.database.db.annotation.Foreign;
import com.nky.database.db.annotation.Id;
import com.nky.database.db.converter.ColumnConverter;
import com.nky.database.db.converter.ColumnConverterFactory;
import com.nky.database.db.sqlite.FinderLazyLoader;
import com.nky.database.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.nky.database.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.nky.database.db.table.Finder finderColumn) {
